          ...
          <div class="col-md-6 mt-2">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title mt-1">Sub Category Update</h3>
              </div>
              <form
                role="form"
                @submit.prevent="SubCategoryUpdate"
              ...
              >
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div
                      class="containError"
                      v-if="errors && errors.sub_category_name"
                    >
                  ...
                  <div class="form-group">
                    ...
                    <div
                      class="containError"
                      v-if="errors && errors.sub_category_img"
                    >
...
export default {
  ...
  created() {
    axios.get("/SubCategoryById/" + this.$route.params.SubCategoryId)
      .then((response) => {
        this.category_id = response.data.subCategoryById.category_id;
        this.sub_category_name = response.data.subCategoryById.sub_category_name;
        this.sub_category_description = response.data.subCategoryById.sub_category_description;
        this.sub_category_img = response.data.subCategoryById.sub_category_img;
      });
  },
