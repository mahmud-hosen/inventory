          ...
          <div class="col-md-6 mt-2">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title mt-1">Expense Add</h3>
              </div>
              <form role="form" @submit.prevent="expenseSave" enctype="multipart/form-data" >
                <div class="card-body">
...
export default {
  ...
  methods: {
    ...
    expenseSave() {
      ...
      axios.post("/expenseStore", form).then((response) => {
